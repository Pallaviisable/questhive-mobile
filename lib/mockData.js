...
export const MOCK_TASKS_BY_GROUP = {
  g1: [
    { id: 't1', title: 'Grocery shopping', description: 'Buy weekly groceries from the market', status: 'PENDING', priority: 'HIGH', assignedTo: 'u2', assignedToName: 'Aarav Sharma', dueDate: '2026-07-12', coins: 20, groupId: 'g1' },
    { id: 't2', title: 'Clean living room', description: 'Vacuum and dust the living room', status: 'COMPLETED', priority: 'MEDIUM', assignedTo: 'u3', assignedToName: 'Meera Iyer', dueDate: '2026-07-09', coins: 15, groupId: 'g1', pendingPeerReview: true, bonusCoinsAmount: 25, peerReviewDeadline: '2026-07-11T18:00:00Z' },
    { id: 't3', title: 'Pay electricity bill', description: 'Due before the 15th', status: 'IN_PROGRESS', priority: 'HIGH', assignedTo: 'u1', assignedToName: 'Pallavi Sable', dueDate: '2026-07-14', coins: 10, groupId: 'g1' },
  ],
  g2: [
    { id: 't4', title: 'Revise Data Mining unit 3', description: 'Similarity measures + clustering', status: 'PENDING', priority: 'HIGH', assignedTo: 'u1', assignedToName: 'Pallavi Sable', dueDate: '2026-07-15', coins: 25, groupId: 'g2' },
  ],
};
