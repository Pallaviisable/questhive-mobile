...
// TODO: replace with your machine's LAN IP for physical device testing
// e.g. 'http://192.168.1.5:8080/api' — 'localhost' won't work on a real phone
// (localhost on a physical device points at the phone itself, not your laptop)
...
// When the backend says the token is no longer valid (expired/revoked),
// clear it and let whoever registered a handler (AuthContext) react —
// e.g. redirect to login. This avoids importing router logic into api.js.
